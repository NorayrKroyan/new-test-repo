  ...
  <div class="inline-flex items-center align-middle">
    ...
    <Teleport to="body">
      <div
          v-if="isOpen"
          ref="popoverRef"
          class="fixed z-[2500] rounded-lg border border-slate-700 bg-slate-900 px-2 py-1.5 text-slate-100 shadow-[0_12px_28px_rgba(2,6,23,0.45)]"
      ...
      >
        <template v-if="isStructured">
          <div class="space-y-1 text-[10px] leading-[1.3]">
            <section>
              <div class="text-[9px] font-semibold uppercase tracking-[0.04em] text-slate-400">
        ...
        <template v-else>
          <div class="text-[10px] leading-[1.35] text-slate-100">
            {{ plainText }}
          </div>
        </template>
      </div>
