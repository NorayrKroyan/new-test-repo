  ...
  >
    <div class="rounded-lg border border-gray-200 bg-white p-2.5">
      ...
      <div class="grid min-w-0 grid-cols-1 gap-y-1 md:grid-cols-2 md:gap-x-3">
        ...
        <ModalFieldRow label="BoldSign Docs:" class="md:col-span-1">
          <div class="field-inline">
            <select
            ...
            >
              <option
                ...
                :key="template.template_id || template.key"
                :value="template.template_id || template.key"
              >
                {{ template.template_name || template.label || template.template_id || template.key }}
              </option>
            </select>
