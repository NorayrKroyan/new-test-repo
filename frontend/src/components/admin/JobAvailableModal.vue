  ...
  >
    <div class="space-y-3">
      <div class="rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-xs text-slate-700">
        <div class="font-semibold text-slate-900">Job Setup</div>
        <div class="mt-1">
          First create the job header. After the job is saved, use <span class="font-semibold">Manage Roster</span>
          to manage the manual primary and spare roster slots.
        </div>

        <div v-if="form.id" class="mt-2 flex flex-wrap items-center gap-2">
          <div
      ...
      <div class="rounded-lg border border-gray-200 bg-white p-3">
        <div class="mb-2 text-xs font-semibold text-gray-900">Job Info</div>
        ...
        <div class="grid grid-cols-1 gap-y-1.5 md:grid-cols-2 md:gap-x-4">
          ...
          <ModalFieldRow label="Origin City:" class="md:col-span-1">
            <div class="field-inline max-w-[260px]">
          ...
          <ModalFieldRow label="Origin State:" class="md:col-span-1">
            <div class="field-inline max-w-[160px]">
          ...
          <ModalFieldRow label="Weight:" class="md:col-span-1">
            <div class="field-inline max-w-[180px]">
          ...
          <ModalFieldRow label="Spare Allowed:" class="md:col-span-1">
            <div class="field-inline max-w-[180px]">
              <input v-model="form.spare_allowed" type="number" min="0" class="field-input" />
              <InlineFieldHelp text="Additional alternate rows allowed beyond the primary requirement." />
            </div>
          </ModalFieldRow>

          <ModalFieldRow label="Rate Description:" class="md:col-span-2">
            <div class="field-inline">
              <textarea v-model="form.rate_description" rows="3" class="field-textarea" />
