      ...
      <div class="rounded-xl border border-gray-200 p-4">
        ...
        <div class="grid grid-cols-1 gap-y-2 md:grid-cols-2 md:gap-x-6">
          <ModalFieldRow label="Stage Name:" class="md:col-span-1">
            <input v-model="form.stage_name" class="w-full max-w-[320px] rounded-lg border border-gray-300 px-3 py-2 text-sm" />
          </ModalFieldRow>
          ...
          <ModalFieldRow label="Stage Order:" class="md:col-span-1">
            <input v-model="form.stage_order" type="number" min="1" class="w-full max-w-[160px] rounded-lg border border-gray-300 px-3 py-2 text-sm" />
          </ModalFieldRow>
