    ...
    <div class="flex min-h-screen">
      <aside class="hidden w-72 shrink-0 border-r border-slate-200 bg-slate-950 text-white lg:flex lg:flex-col">
        <div class="border-b border-slate-800 px-6 py-5">
          ...
          <div class="mt-2 text-xl font-semibold">Carrier Portal</div>
        </div>

        <nav class="space-y-1 p-4">
          <RouterLink :to="'/carrier/dashboard'" :class="navLinkClass('/carrier/dashboard')">Dashboard</RouterLink>
        </nav>
        ...
        <div class="border-b border-slate-200 bg-white lg:hidden">
          <div class="flex items-center justify-between px-3 py-3">
            <div>
              ...
              <div class="text-base font-semibold text-slate-900">Carrier Portal</div>
            </div>
          ...
          <div v-if="mobileNavOpen" class="border-t border-slate-200 px-3 py-3">
            <nav class="grid grid-cols-1 gap-2">
              <RouterLink
                  ...
                  :class="mobileNavLinkClass('/carrier/dashboard')"
...
import { carrierLogout } from '../api/carrier'
