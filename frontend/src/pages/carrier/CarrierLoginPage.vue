<template>
  <div class="flex min-h-screen items-center justify-center bg-slate-100 p-4">
    <div class="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      <h1 class="text-2xl font-semibold text-slate-900">Carrier Login</h1>
      ...
      <div class="mt-6 space-y-4">
        ...
        <RouterLink to="/carrier/register" class="block text-center text-sm font-medium text-sky-700 hover:underline">
          Register as Carrier
        </RouterLink>
      </div>
    </div>
