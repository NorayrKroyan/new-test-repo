<template>
  <div class="flex min-h-screen items-center justify-center bg-slate-100 p-4">
    <div class="w-full max-w-2xl rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
      <h1 class="text-2xl font-semibold text-slate-900">Carrier Registration</h1>
      <p class="mt-1 text-sm text-slate-500">Create your carrier account</p>
      ...
      <div class="mt-6 flex gap-3">
        ...
        <RouterLink to="/carrier/login" class="rounded-xl border border-slate-300 px-5 py-3 text-sm font-medium text-slate-700 hover:bg-slate-50">
          Back to Login
        </RouterLink>
      </div>
    </div>
