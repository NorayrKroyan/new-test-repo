<template>
  <AdminLayout>
    <div class="carriers-page space-y-1">
      <div class="top-card rounded-2xl border border-slate-200 bg-white px-4 py-1.5 shadow-sm">
        <div class="flex flex-col gap-2 xl:flex-row xl:items-center xl:justify-between">
          <div>
            <h1 class="text-2xl font-semibold leading-tight text-slate-900">Carriers</h1>
          </div>
      ...
      >
        <DataTable
            class="display nowrap compact stripe row-border hover carriers-datatable w-full"
            :data="rows"
            :columns="columns"
            :options="options"
        />
...
const columns = [
  ...
  },
  {
    ...
    data: null,
    render: (_data, type, row) => {
      const trucks = Number(row.truck_count || 0)
      const trailers = Number(row.trailer_count || 0)
...
const options = {
  ...
  order: [[0, 'asc']],
  language: {
    emptyTable: 'No carriers found',
    zeroRecords: 'No carriers found',
  },
}
...
function handleTableClick(event) {
  const editBtn = event.target.closest('.carrier-edit-link')
  if (editBtn) {
...
.carriers-page .top-card {
  padding-top: 6px;
  padding-bottom: 6px;
}

.carriers-page .dt-container {
  padding: 0;
}

.carriers-page .dt-container .dt-layout-row {
  display: flex;
  align-items: center;
...
.carriers-page .dt-container .dt-layout-row:first-child {
  padding-top: 2px;
  padding-bottom: 2px;
}

.carriers-page .dt-container .dt-layout-row:last-child {
  padding-top: 2px;
  padding-bottom: 2px;
}

.carriers-page .dt-container .dt-layout-cell {
  margin: 0;
}

.carriers-page .dt-container .dt-length,
.carriers-page .dt-container .dt-info,
.carriers-page .dt-container .dt-paging {
  font-size: 12px;
  color: #475569;
}

.carriers-page .dt-container .dt-length label {
  display: inline-flex;
  align-items: center;
  gap: 6px;
  white-space: nowrap;
...
.carriers-page .dt-container .dt-length select {
  min-width: 76px;
  height: 28px;
...
.carriers-page .dt-container .dt-paging .dt-paging-button {
  min-width: 28px;
  height: 28px;
  margin: 0 2px;
...
.carriers-page .dt-container .dt-paging .dt-paging-button.current,
.carriers-page .dt-container .dt-paging .dt-paging-button.current:hover {
  border-color: #0f172a !important;
  background: #0f172a !important;
  color: #fff !important;
}

.carriers-page .dt-container .dt-paging .dt-paging-button:hover {
  background: #f8fafc !important;
  color: #0f172a !important;
}

.carriers-page .dt-scroll-head table.dataTable,
.carriers-page .dt-scroll-body table.dataTable,
.carriers-page table.dataTable {
  margin-top: 0 !important;
  margin-bottom: 0 !important;
}

.carriers-page table.dataTable thead th {
  white-space: nowrap;
  font-size: 13px;
...
.carriers-page table.dataTable tbody td {
  white-space: nowrap;
  font-size: 13px;
...
.carriers-page table.dataTable tbody tr:hover {
  background: #f8fafc;
}

.carriers-page .carrier-edit-link {
  border: 0;
...
.carriers-page .carrier-edit-link:hover {
  text-decoration: underline;
}

.carriers-page .status-badge {
  display: inline-flex;
  align-items: center;
...
.carriers-page .status-badge--pending {
  background: #fff7ed;
  border-color: #fed7aa;
  color: #c2410c;
}

.carriers-page .status-badge--active {
  background: #ecfdf5;
  border-color: #a7f3d0;
  color: #047857;
}

.carriers-page .status-badge--inactive {
  background: #f8fafc;
  border-color: #cbd5e1;
  color: #475569;
}

.carriers-page .status-badge--default {
  background: #eff6ff;
  border-color: #bfdbfe;
  color: #1d4ed8;
}
