...
function D3WaterFallFormat(params) {
  console.log('D3WaterFallFormat');
  return KoolReport.d3.format(params.decimals,params.decPoint,params.thousandSep,params.prefix,params.suffix);
}